...
const CityInput = forwardRef(({ defaultValue = '', errorMessage, country, city, setCity, ...rest }, ref) => {
  ...
  return (
    <div className={styles.input_container} ref={dropdownRef}>
      ...
      {cityTouched && !city && <span className={styles.error_message}>{errorMessage || t('selectCity')}</span>}
